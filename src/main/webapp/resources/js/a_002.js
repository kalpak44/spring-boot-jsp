(function () {
    ...
    project_data["token"] = "3b08ec312cc263cea4f37dc6efa74415";
    project_data["coordinatesOrder"] = "latlong";
    project_data.share = 0.2350913236071439;
    project_data["geolocation"] = {
        "longitude": 23.324307,
        "latitude": 42.697177,
        "isHighAccuracy": false,
        "city": "София",
        "region": "Городская область София",
        "country": "Болгария",
        "zoom": 10
    };
    project_data["layers"] = {
        'map': {version: '17.06.02-2', scaled: true, hotspotZoomRange: [13, 23]},
        'sat': {version: '3.322.0'},
        'skl': {version: '17.06.02-2', scaled: true, hotspotZoomRange: [13, 23]},
